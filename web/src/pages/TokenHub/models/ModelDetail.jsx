...
const modelDataMap = {
  'telechat2': {
    ...
    maxOutput: '8,192',
    pricing: [
      { label: '输入（每百万tokens）', officialPrice: '$0.60', ourPrice: '$0.57', savings: '5%' },
      { label: '输出（每百万tokens）', officialPrice: '$3.00', ourPrice: '$2.85', savings: '5%' }
    ],
    features: [
  ...
  'glm-47': {
    ...
    maxOutput: '8,192',
    pricing: [
      { label: '输入（每百万tokens）', officialPrice: '$10.00', ourPrice: '$9.50', savings: '5%' },
      { label: '输出（每百万tokens）', officialPrice: '$30.00', ourPrice: '$28.50', savings: '5%' }
    ],
    features: [
      { label: '上下文长度', value: '128,000' },
      { label: '最大输出', value: '8,192' },
      { label: '函数调用', value: '支持', highlight: true },
      { label: '结构化输出', value: '支持', highlight: true },
      { label: '推理', value: '支持', highlight: true },
...
const ModelDetail = () => {
  ...
  const modelData = modelDataMap[modelId] || modelDataMap['glm-47']; // 默认显示 GLM-4.7
...
func main() {
  ...
  const codeExamples = getCodeExamples(modelData.modelId);
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC]">
      ...
      <div className="relative w-full mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 pt-24 pb-16">
        ...
        <div className="bg-white rounded-2xl p-5 shadow-sm">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            ...
            <div className="flex items-center gap-5">
              {/* 模型图标 */}
              <div className={`w-16 h-16 rounded-xl bg-gradient-to-br ${modelData.iconGradient} flex items-center justify-center text-white shadow-lg`}>
                <span className="text-2xl font-bold">{modelData.iconLetter}</span>
              </div>
              <div className="flex items-center gap-40">
                <div>
                  ...
                  <div className="flex items-center gap-2 text-sm">
                    <code className="px-2 py-1 bg-gray-50 rounded-md text-gray-500 font-mono text-xs border border-gray-100">{modelData.modelId}</code>
                    <button
                      className="p-1.5 text-gray-400 hover:text-blue-600 hover:bg-blue-50 rounded-md transition-colors"
                      onClick={() => navigator.clipboard.writeText(modelData.modelId)}
                      title={t('复制模型ID')}
                    >
                      <IconCopy size={14} />
                    </button>
        ...
        <div className={`w-full rounded-3xl p-8 transition-all mb-8 duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
            ...
            <div className="flex-1 flex flex-col">
              <div className="bg-white rounded-2xl p-5 shadow-sm">
                ...
                <div className="bg-white rounded-2xl p-5 shadow-sm">
                  ...
                  {/* 表格内容 */}
                  {modelData.pricing.map((item, index) => (
                    <div
                      key={item.label}
              ...
              <div className="bg-white rounded-2xl p-5 shadow-sm">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center py-3 border-b border-gray-100">
                    ...
                    <span className="text-sm font-medium text-[#1E293B]">{modelData.provider}</span>
                  </div>
                  <div className="flex justify-between items-center py-3 border-b border-gray-100">
                  ...
                  <div className="flex justify-between items-center py-3">
                    ...
                    <span className="text-sm font-medium text-[#1E293B]">{modelData.version}</span>
                  </div>
                </div>
              </div>
