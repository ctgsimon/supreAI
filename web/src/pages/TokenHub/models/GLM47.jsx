...
// GLM-4.7模型详情页面 - ui-ux-pro-max设计系统优化
const GLM47 = () => {
                ...
                <div className="flex items-center gap-40">
                  <div>
                    ...
                    <div className="flex items-center gap-2 text-sm">
                      <code className="px-2 py-1 bg-gray-50 rounded-md text-gray-500 font-mono text-xs border border-gray-100">glm-4.7</code>
                      <button 
                        className="p-1.5 text-gray-400 hover:text-blue-600 hover:bg-blue-50 rounded-md transition-colors"
                        onClick={() => navigator.clipboard.writeText('glm-4.7')}
                        title={t('复制模型ID')}
                      >
                        <IconCopy size={14} />
                      </button>
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center py-3">
                  ...
                  <span className="text-sm font-medium text-[#1E293B]">4.7</span>
                </div>
              </div>
            </div>  
